...
It improves detection of periodicity in the pseudo-random sequence by replacing Floyd's cycle-finding algorithm with a similar method called Brent's cycle-finding.\cite{brent}
