...
The algorithm then runs $gcd(\abs{x_{2i}-x_i}, N)$. If the result is greater than 1, the result is a non-trivial factor of $N$.
\\
...
Some improvements were later made to the algorithm by Richard Brent and John Pollard.\cite{brent}
...
\begin{algorithm}[H]
 ...
 \caption{Pseudocode for Pollard's rho algorithm, without improvements}
\end{algorithm}
