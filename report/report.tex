...
\subsection{Problem}
A prime number is a positive integer (> 1) that has no positive integer divisors other 1 and itself. The prime factorization of a positive integer is a list of primes that divides the integer, and their multiplicities. The problem of finding these prime factors is called integer factorization.
...
Pollard's rho algorithm (\url{http://en.wikipedia.org/wiki/Pollard's_rho_algorithm})
