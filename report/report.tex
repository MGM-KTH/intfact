...
Another paper that describes several algorithms, including Brent (not the version we're using, this one gave \~57 in Kattis. A lot simpler though.): \url{http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.117.1230&rep=rep1&type=pdf}
