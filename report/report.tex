...
We are not sure why setting the value of $C$ to 3 as suggested by Brent gave worse time than setting it to 1 as in the original Pollard's algorithm.
Perhaps, this was due to poor interaction with other variables, or some arcane difference in hardware.
...
But given more time (or better planning\dots) we would have liked to try to implement the Quadratic Sieve algorithm.
