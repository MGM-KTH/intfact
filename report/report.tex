...
%-------------------------------------------------------------------------------
\section{Method}
The factorization program was written in |C| and uses the library GMP\footnote{\url{http://gmplib.org}} to represent large numbers, perform functions such as primality testing and GCD.
...
Before each iteration of PR, primality testing is performed. This is done using GMP's built-in function |mpz_probab_prime| which uses trial division and Miller-Rabin probabilistic primality tests internally.\footnote{\url{http://gmplib.org/manual/Number-Theoretic-Functions.html}}
...
Brent's factorization method (BFM) (\url{http://maths-people.anu.edu.au/~brent/pub/pub051.html})
